...
from sklearn.metrics.pairwise import cosine_similarity,polynomial_kernel, laplacian_kernel
...
class Task():
    ...
    def get_reward(self):
        ...
        [[reward]] = cosine_similarity(self.sim.pose[:3].reshape(1, -1), self.target_pos.reshape(1, -1))
        # print('reward', reward)
